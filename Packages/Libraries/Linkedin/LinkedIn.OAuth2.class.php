...
//require_once(__ROOT__.'/social-media-api-LinkedIn/OAuth2.class.php');
include PATH_typo3conf.'/ext/social_publisher/Packages/Libraries/Linkedin/OAuth2.class.php';
...
class LinkedInOAuth2 extends OAuth2 {
	...
	public function shareStatus($args){
		//var_dump($args);
	...
	public function postToCompany($company_id,$message,$content){
