# -*- coding: utf-8 -*-
#
# Social Publisher documentation build configuration file, created by
# TYPO3 extension sphinx on Fri, 08 Jul 2016 14:06:49 +0530.
#
...
project = u'Social Publisher'
copyright = u'2016, Siju E Raju'
...
htmlhelp_basename = 'social_publisherdoc'
...
latex_documents = [
    ('Index', 'social_publisher.tex', u'Social Publisher',
     u'Siju E Raju', 'manual'),
]
...
pdf_documents = [
    ('Index', 'social_publisher', u'Social Publisher',
     u'Siju E Raju'),
]
...
texinfo_documents = [
    ('Index', 'social_publisher', u'Social Publisher',
     u'Siju E Raju', 'Social Publisher', 'One line description of project.',
     'Miscellaneous'),
]
