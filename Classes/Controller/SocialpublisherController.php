...
/**
 * SocialpublisherController
 */
class SocialpublisherController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	public function listAction() {		
		//$socialpublishers = $this->socialpublisherRepository->findAll();
